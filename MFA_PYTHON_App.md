<div align="center">
<h1 align="center">Mining Fracture Analyser (MFA) v5.12</h1>
<p align="center">
...
**Version 5.12** introduces **Dynamic Loadout Strategy**, **Full Telemetry Unlocks**, and an enhanced **AI Senior Foreman** powered by **Gemini 2.5 Flash**.
...
Create a new folder on your computer (e.g., Desktop\\MFA\_Tool) and save the files (index.html, script.js, style.css, and run\_app.py) inside it.
...
3. **Enter Key:** • Look for the "Senior Foreman AI" section in the right-hand column.  
   ...
   • The key is saved locally within the app (with memory fallback for security).
...
The AI is now powered by **Gemini 2.5 Flash** and supports pre-deployment analysis. The **Analytics Column** (Column 4\) offers 4 modes:

1\. 🧠 **STRATEGY** *Use this when:* You need a general assessment before or after deployment.

• Analyzes the rock's mass/resistance against your current (or hypothetical) fleet power.

• Advises on whether the fracture is safe or if you need more lasers.

2\. ⚠️ **RISK REPORT** *Use this when:* Dealing with High Instability.

• Calculates the probability of an explosion.

• Recommends safe distances and specific stability modules.

3\. 🔧 **LOADOUT** *Use this when:* You want to optimize.

• Suggests the mathematically perfect module combinations (Surge, Brandt, Torrent) for the specific rock you are facing.

• Now works dynamically with the **Optimized Fleet Loadouts** panel to suggest Stability vs. Power builds based on the rock's stats.

4\. 📢 **ORDERS** *Use this when:* You are the Crew Commander.

• Generates a formatted "Command Uplink" text block to read aloud or paste into the game chat.

## **📷 Phase 5: Live OCR & Scanning**

MFA v5.12 can "see" your game screen to automatically input data.
...
• "Live Scan shows a black screen": Ensure Star Citizen is running in Borderless Windowed mode for best compatibility with screen capture.
